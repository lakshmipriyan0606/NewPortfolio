...
const Service = ({service}) => {
  ...
  return (
    <section className="my-9" ref={service} id="service">
  ...
  <div className="w-full sm:h-[350px] lg:h-[400px] mt-5 bg-white shadow-2xl flex flex-col gap-6 justify-center items-center border-b-4 border-blue-700 p-5" data-aos="zoom-in" data-aos-duration="1000">
  ...
  <div className="w-full lg:h-[400px] mt-14 bg-white shadow-2xl flex flex-col gap-6 justify-center items-center border-b-4 border-red-600 p-5" data-aos="zoom-in" data-aos-duration="1000">
  ...
  <div className="w-full lg:h-[400px] mt-14 bg-white shadow-2xl flex flex-col gap-6 justify-center items-center border-b-4 border-yellow-500 p-5" data-aos="zoom-in" data-aos-duration="1000">
  ...
  <div className="w-full lg:h-[400px] mt-14 bg-white shadow-2xl flex flex-col gap-6 justify-center items-center border-b-4 border-[#2FA499] p-5" data-aos="zoom-in" data-aos-duration="1000">
   ...
   {/* <section className="p-5">
        ...
        {
          count &&    <div className=" grid-cols-1 grid place-items-center gap-6">
          <div className="flex flex-col gap-3 justify-center items-center my-2 text-white  sm:left-[38%] md:left-[40%]  absolute  top-10 text-xl font-medium">
          ...
          <div className="flex flex-col gap-3 justify-center items-center my-2 text-white  absolute sm:left-[43%]  top-40 text-xl font-medium">
          <CountUp  className='text-[40px]'
              start={0}
              end={10}
              duration={7} 
          ...
          <div className="flex flex-col gap-3 justify-center items-center my-2 text-white  absolute sm:left-[44%]  top-64 mt-4 text-xl font-medium">
          <CountUp  className='text-[40px]'
              start={0}
              end={5}
              duration={6} 
          ...
          <div className="flex flex-col gap-3 justify-center items-center my-2 text-white  absolute sm:left-[43%]  top-96 mt-4 text-xl font-medium">
          <CountUp  className='text-[40px]'
              start={0}
              end={3}
              duration={8} 
